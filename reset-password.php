                                  ...
                                  <div class="xx3">
                                    <div class="xx4">
                                      <div class="xx5">
                                        <div class="xx6">
                                            <div class="xx6v1">
                                              <input type="text" name="email" aria-label="输入邮件 Enter e-mail" value autocapitalize="none" id="loginbox" class="xx7" spellcheck="false" tabindex="0" initial-dir="ltr" dir="ltr">
                                              <div id="xx8v3" data-mlr-text class="xx8 中文" aria-hidden="true">输入邮件 Enter e-mail</div>
                                            </div>
