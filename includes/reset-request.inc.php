...
//require a bunch of composer files to send emails with
require 'C:/Users//node_modules/moment_timezone/vendor/PHPMailer/PHPMailer/src/Exception.php';
require 'C:/Users//node_modules/moment_timezone/vendor/PHPMailer/PHPMailer/src/PHPMailer.php';
require 'C:/Users//node_modules/moment_timezone/vendor/PHPMailer/PHPMailer/src//SMTP.php';

 // Load Composer's autoloader
 require_once 'C:/Users//node_modules/moment_timezone/vendor/autoload.php';
     ...
     if (isset($_POST["reset-request-submit"])) {
       ...
       $url = "http://localhost/rootfolder/create-new-password.php?selector=" . $selector . "&validtor=" . bin2hex($token); //Change to website name
       ...
       mysqli_close();
        ...
        $mail->Subject = "Reset your password for qiu.com";
        $mail->Body = "
